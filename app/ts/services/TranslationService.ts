...
export class TranslationService {
  ...
  constructor (private http: Http) {
      ...
      this.apiKey = "trnsl.1.1.20160424T175748Z.b14b726c783491a9.a32ac80420e3535516377dd996efc559e691639f";
  }

  getTranslation(translationSource:string): Observable<string[]> {
    let urlString = `${this.translateUrl}?key=${this.apiKey}&text=${translationSource}&lang=en-es`;
